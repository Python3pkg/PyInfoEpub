...
from pyinfoepub.src.info_epub import *
...
class InfoEpubTest(unittest.TestCase):
    ...
    def test_info_epub_after_init(self):
        ...
        self.assertEqual(self.info_epub.epub_content, {}, 'Content should be an empty dict.')
        self.assertEqual(self.info_epub.opf, None, 'OPF should be None.')
        self.assertFalse(self.info_epub.deprecated_flag, 'Deprecated flag should be False.')
